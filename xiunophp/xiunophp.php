...
/*
	...
	采用静态语言编程风格，有利于 Zend 引擎的编译和 OPCache 缓存，支持 PHP7/8
...
$_REQUEST = array_merge($_POST, $_GET, xn_url_parse($_SERVER['REQUEST_URI']));
$_REQUEST += $_COOKIE;
...
// 支持连接池友好化：db_static() 可被 Swoole/Workerman 常驻进程复用
...
// 连接池静态访问器（Swoole/Workerman 环境下可替换为连接池实现）
function db_static() { return $_SERVER['db']; }
function cache_static() { return $_SERVER['cache']; }
