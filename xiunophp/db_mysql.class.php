...
// PHP 8.0+ 下 mysql_* 函数已完全移除，仅当类尚未定义时才处理
if(!class_exists('db_mysql', false)) {

// PHP 7.0+ 已完全移除 mysql_* 函数，此驱动仅用于 PHP 5.x 兼容
if(version_compare(PHP_VERSION, '7.0', '>=')) {
    class db_mysql {
        ...
        public function __construct($conf) {
            ...
            xn_error(-1, 'db_mysql 驱动不支持 PHP 7.0+，请使用 pdo_mysql 驱动');
        }
        public function connect() { return FALSE; }
        public function connect_master() { return FALSE; }
        public function connect_slave() { return FALSE; }
        public function real_connect($host, $user, $password, $name, $charset = '', $engine = '') { return FALSE; }
        public function sql_find_one($sql) { return FALSE; }
        public function sql_find($sql, $key = NULL) { return FALSE; }
        public function find($table, $cond = array(), $orderby = array(), $page = 1, $pagesize = 10, $key = '', $col = array()) { return FALSE; }
        public function find_one($table, $cond = array(), $orderby = array(), $col = array()) { return FALSE; }
        public function query($sql, $link = NULL) { return FALSE; }
        public function exec($sql, $link = NULL) { return FALSE; }
        public function count($table, $cond = array()) { return FALSE; }
        public function maxid($table, $field, $cond = array()) { return FALSE; }
        public function truncate($table) { return FALSE; }
        public function close() { return TRUE; }
        public function version() { return ''; }
        public function error($errno = 0, $errstr = '') {}
        public function is_support_innodb() { return FALSE; }
