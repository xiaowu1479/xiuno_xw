...
*/
	...
	if($method == 'GET') {
		...
		!user_password_verify($password_old, $user) AND message('password_old', lang('old_password_incorrect'));
		$r = user_update($uid, array('password'=>user_password_hash($password_new)));
