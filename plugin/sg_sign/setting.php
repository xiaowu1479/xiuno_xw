...
if($method == 'GET') {
	...
	$input['sign10'] = form_select('sign10',array('08599E'=>lang('blue'), 'c62f2f'=>lang('red'), '009a61'=>lang('green'), 'FA884F'=>lang('orange')), $kv['sign10']);
	$input['sign11'] = form_radio_yes_no('sign11', $kv['sign11']);
	include _include(APP_PATH.'plugin/sg_sign/htm/setting.htm');
} else {
	$kv = array();
