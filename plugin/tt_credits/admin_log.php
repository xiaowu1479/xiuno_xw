...
<tr><td><?php echo $v['cid'];?></td><td><?php echo username($v['uid']);?></td><td><?php echo date('Y-m-d H:i:s',$v['time']); ?></td><td><?php echo $g_credits_type_array[$v['type']];?>,<?php echo $g_credits_status_array[$v['status']+1];?></td><td><?php echo $c_type=='3'?$v['num']/1:$v['num'],' '.lang('credits'.$c_type); ?></td><td><?php if(!empty($v['code'])) echo '记录:',$v['code']; ?></td>
</tr><?php }?></table>
