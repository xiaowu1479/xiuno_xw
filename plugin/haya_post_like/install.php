...
// 帖子点赞
$sql = "
CREATE TABLE IF NOT EXISTS {$tablepre}post_like (
...
!db_sql_find_one("SHOW COLUMNS FROM {$tablepre}post LIKE 'likes'") AND db_exec("ALTER TABLE {$tablepre}post ADD COLUMN likes int(11) NULL DEFAULT '0' COMMENT '点赞数'");
!db_sql_find_one("SHOW COLUMNS FROM {$tablepre}thread LIKE 'likes'") AND db_exec("ALTER TABLE {$tablepre}thread ADD COLUMN likes int(11) NULL DEFAULT '0' COMMENT '点赞数'");
