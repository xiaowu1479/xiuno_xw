...
<div class="card">
    <div class="card-header font-weight-bold">确定释放</div>
    <div class="card-body ajax-body">
        <form action="<?php echo url("mod-openuser-all");?>" method="post" id="mod_openuser_form">
        <div class="form-group row">
            <label class="col-4 form-control-label text-right"></label>
            <div class="col-12 text-center">共释放 <span class="total font-weight-bold text-danger"></span> 个用户</div>
        </div>
        <div class="form-group row">
            <label class="col-4 form-control-label text-right"></label>
            <div class="col-8">
                <button type="submit" class="btn btn-primary mr-2" data-loading-text="<?php echo lang('submiting');?>...">确定释放</button>
