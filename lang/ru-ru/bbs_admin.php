...
return array(
	...
	'online_hold_time'=>'Время удержания онлайн (секунды)',
	'online_hold_time_tips'=>'Диапазон для подсчёта онлайн: посетители, активные в течение этого периода, считаются онлайн. По умолчанию 3600 (1 час); для малых сайтов 600 (10 мин)',
	...
	'admin_update_check_now'=>'Проверить сейчас',
	'admin_update_latest'=>'У вас последняя версия',
	'admin_update_found'=>'Доступна новая версия',
	'admin_update_release_date'=>'Дата выпуска',
	'admin_update_notes'=>'Примечания к выпуску',
	'admin_update_error'=>'Не удалось подключиться к серверу обновлений, проверьте сеть и повторите попытку',
	'admin_update_download'=>'Скачать исходный код',
	'admin_update_github'=>'Страница GitHub',
	'admin_update_auto'=>'Автообновление в один клик',
	'admin_update_confirm'=>'Вы действительно хотите автоматически обновиться до последней версии? Система автоматически создаст резервную копию данных и перезапишет файлы программы. Не закрывайте страницу в процессе.',
	'admin_update_locked'=>'Обновление уже выполняется, повторите позже',
	'admin_update_no_download'=>'Не найден доступный пакет обновления',
	'admin_update_download_failed'=>'Не удалось скачать пакет обновления, проверьте сеть сервера и повторите',
	'admin_update_bad_package'=>'Неверный формат пакета обновления (поддерживаются zip / tar.gz)',
	'admin_update_unzip_failed'=>'Не удалось распаковать пакет обновления, повторите',
	'admin_update_success'=>'Автообновление завершено, обновлено до версии {version}',
	'admin_update_backup_done'=>'Автоматически сохранено в {dir}, вы можете откатить версию одним кликом в разделе «Откат резервной копии» ниже',
	'admin_update_backup_title'=>'Откат резервной копии',
	'admin_update_backup_tip'=>'Перед каждым автообновлением / откатом основная программа автоматически сохраняется в папку backup/, хранятся только последние 2 копии. Можно откатиться к любой из них одним кликом.',
	'admin_update_backup_empty'=>'Резервных копий пока нет',
	'admin_update_backup_time'=>'Время резервной копии',
	'admin_update_backup_version'=>'Версия',
	'admin_update_rollback'=>'Откат',
	'admin_update_rollback_confirm'=>'Вы действительно хотите откатиться к этой резервной копии? Файлы основной программы будут перезаписаны; загрузки/конфигурация/журналы не затрагиваются. Не закрывайте страницу в процессе.',
	'admin_update_rollback_success'=>'Откат выполнен, восстановлено из резервной копии {dir}',
	'admin_update_backup_delete'=>'Удалить',
	'admin_update_backup_delete_confirm'=>'Вы действительно хотите удалить эту резервную копию? Это действие необратимо!',
	'admin_update_backup_deleted'=>'Резервная копия удалена',
	'admin_update_backup_invalid'=>'Недопустимое имя папки резервной копии',
	'admin_update_backup_not_exists'=>'Резервная копия не найдена',
	...
	'captcha_login_on'=>'Код при входе',
	'captcha_reg_on'=>'Код при регистрации',
	'captcha_post_on'=>'Код при создании',
	'captcha_tips'=>'Настройки кода проверки: требуется при входе/регистрации/создании',
