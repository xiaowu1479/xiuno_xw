...
return array(
	...
	'license_content' => '感谢您选择 xiuno_xw 1.0.0，它是一款基于 Xiuno BBS 4.1.1 二次开发的轻论坛，国产、小巧、稳定、支持在大数据量下仍然保持高负载能力。它只有 20 多个表，源代码压缩后 1M 左右，运行速度非常快，处理单次请求在 0.01 秒级别，全面支持 PHP 8.x，对第三方类库依赖极少，仅仅前端依赖 jquery.js，方便部署和维护，是一个非常好的二次开发的基石。

xiuno_xw 1.0.0 全面兼容 PHP 8.0 - 8.4，修复了 SMTP 邮件系统，升级了缓存机制，新增文件缓存驱动，支持 Redis 密码认证等现代特性。

xiuno_xw 基于 Xiuno BBS 4.1.1 (MIT 协议) 二次开发，您可以自由修改、派生版本、商用而不用担心任何法律风险（修改后应保留原来的版权信息）。',
