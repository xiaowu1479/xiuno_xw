...
return array(
	...
	'online_hold_time'=>'ระยะเวลาออนไลน์ (วินาที)',
	'online_hold_time_tips'=>'ช่วงเวลาสำหรับนับออนไลน์: ผู้เยี่ยมชมที่ใช้งานภายในช่วงนี้จะนับเป็นออนไลน์ ค่าเริ่มต้น 3600 (1 ชั่วโมง); แนะนำ 600 (10 นาที) สำหรับเว็บเล็ก',
	...
	'admin_update_check_now'=>'ตรวจสอบตอนนี้',
	'admin_update_latest'=>'คุณใช้เวอร์ชันล่าสุดแล้ว',
	'admin_update_found'=>'พบเวอร์ชันใหม่',
	'admin_update_release_date'=>'วันที่เผยแพร่',
	'admin_update_notes'=>'หมายเหตุการอัปเดต',
	'admin_update_error'=>'ไม่สามารถเชื่อมต่อเซิร์ฟเวอร์อัปเดตได้ โปรดตรวจสอบเครือข่ายแล้วลองใหม่',
	'admin_update_download'=>'ดาวน์โหลดซอร์สโค้ด',
	'admin_update_github'=>'หน้า GitHub',
	'admin_update_auto'=>'อัปเดตอัตโนมัติด้วยคลิกเดียว',
	'admin_update_confirm'=>'ยืนยันที่จะอัปเดตเป็นเวอร์ชันล่าสุดหรือไม่? ระบบจะสำรองข้อมูลและเขียนทับไฟล์โปรแกรมอัตโนมัติ กรุณาอย่าปิดหน้านี้ระหว่างดำเนินการ',
	'admin_update_locked'=>'กำลังมีการอัปเดตอยู่ กรุณาลองใหม่ภายหลัง',
	'admin_update_no_download'=>'ไม่พบที่อยู่ดาวน์โหลดแพ็กเกจอัปเดต',
	'admin_update_download_failed'=>'ดาวน์โหลดแพ็กเกจอัปเดตล้มเหลว กรุณาตรวจสอบเครือข่ายของเซิร์ฟเวอร์แล้วลองใหม่',
	'admin_update_bad_package'=>'รูปแบบแพ็กเกจอัปเดตไม่ถูกต้อง (รองรับเฉพาะ zip / tar.gz)',
	'admin_update_unzip_failed'=>'ไม่สามารถแตกไฟล์แพ็กเกจอัปเดตได้ กรุณาลองใหม่',
	'admin_update_success'=>'อัปเดตอัตโนมัติเสร็จสมบูรณ์ อัปเกรดเป็นเวอร์ชัน {version} แล้ว',
	'admin_update_backup_done'=>'สำรองข้อมูลอัตโนมัติไปที่ {dir} แล้ว คุณสามารถย้อนกลับได้ด้วยคลิกเดียวในส่วน "ย้อนกลับสำรอง" ด้านล่าง',
	'admin_update_backup_title'=>'ย้อนกลับสำรอง',
	'admin_update_backup_tip'=>'ก่อนการอัปเดต / ย้อนกลับอัตโนมัติทุกครั้ง ระบบจะสำรองโปรแกรมหลักไปยังโฟลเดอร์ backup/ โดยเก็บเพียง 2 ชุดล่าสุด และสามารถย้อนกลับได้ด้วยคลิกเดียว',
	'admin_update_backup_empty'=>'ยังไม่มีข้อมูลสำรอง',
	'admin_update_backup_time'=>'เวลาสำรอง',
	'admin_update_backup_version'=>'เวอร์ชัน',
	'admin_update_rollback'=>'ย้อนกลับ',
	'admin_update_rollback_confirm'=>'ยืนยันที่จะย้อนกลับไปยังข้อมูลสำรองนี้หรือไม่? ไฟล์โปรแกรมหลักจะถูกเขียนทับ อัปโหลด/คอนฟิก/ล็อกจะไม่ได้รับผลกระทบ กรุณาอย่าปิดหน้านี้ระหว่างดำเนินการ',
	'admin_update_rollback_success'=>'ย้อนกลับสำเร็จ กู้คืนจากข้อมูลสำรอง {dir} แล้ว',
	'admin_update_backup_delete'=>'ลบ',
	'admin_update_backup_delete_confirm'=>'ยืนยันที่จะลบข้อมูลสำรองนี้หรือไม่? การดำเนินการนี้ไม่สามารถย้อนกลับได้!',
	'admin_update_backup_deleted'=>'ลบข้อมูลสำรองแล้ว',
	'admin_update_backup_invalid'=>'ชื่อโฟลเดอร์สำรองไม่ถูกต้อง',
	'admin_update_backup_not_exists'=>'ไม่พบข้อมูลสำรอง',
	...
	'captcha'=>'รหัสยืนยัน',
	'captcha_login_on'=>'รหัสยืนยันการเข้าสู่ระบบ',
	'captcha_reg_on'=>'รหัสยืนยันการสมัคร',
	'captcha_post_on'=>'รหัสยืนยันการโพสต์',
	'captcha_tips'=>'ตั้งค่ารหัสยืนยัน: ต้องใช้เมื่อเข้าสู่ระบบ/สมัคร/โพสต์',
